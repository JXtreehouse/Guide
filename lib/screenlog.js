...
(function () {
	...
	function createPanel() {
		var div = createElement('div', 'z-index:2147483647;font-family:Helvetica,Arial,sans-serif;font-size:10px;font-weight:bold;padding: 5px;text-align:left;opacity:0.8;position:fixed;right:-10px;bottom:0;width:100%;height:15%;overflow:auto;background:' + _options.bgColor + ';' + _options.css);
		return div;
	}
